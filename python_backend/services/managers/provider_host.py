...
class ProviderHostManager:
    def __init__(self, config: Any, capability: str):
        ...
        self.last_error_driver_id: Optional[str] = None
    ...
    def begin_transition(self, target_id: str):
        ...
        self.last_error_driver_id = None
    ...
    def mark_error(self, message: str):
        ...
        self.last_error_driver_id = (
            self.active_driver_id if self.active_driver_id != "none" else None
        )
        self.active_driver = None
        self.loading_status = "idle"
        if self.last_transition_started_at is not None:
    ...
    def snapshot_provider_state(self, provider_id: str) -> dict[str, Any]:
        ...
        if provider_id == self.last_error_driver_id:
            active_status = "error"
        elif is_active:
        ...
        return {
            ...
            "error": self.last_error if provider_id == self.last_error_driver_id else None,
            "load_time_ms": self.last_load_duration_ms if provider_id in {self.active_driver_id, self.last_error_driver_id} else None,
        }
