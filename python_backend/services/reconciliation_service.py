...
class ReconciliationService:
    ...
    Monitors the 'plugin_state' table in SurrealDB and enforces the Desired State.
    """
    ...
    async def _reconcile_plugin(self, pid: str, state: Dict[str, Any], now_ts: float):
        ...
        # SurrealDB returns ISO strings or datetime objects usually.
        ...
        # Check SurrealLifecycleBus.publish_state -> updates 'updated_at'.
        # Check SurrealLifecycleBus.send_heartbeat -> updates 'last_seen' on worker_heartbeats table.
